<html>
	<head>
		<title>PORTFOLIO | D'Andr&eacute; Phillips </title>
		...
		<!-- <meta http-equiv="refresh" content="3;URL="obout.php"> -->
	</head>
	...
	<div class="container">
		...
		<div class="cover-section col-xs-11 col-sm-8 col-md-6 col-lg-4">
			<h1>I am D'Andr&eacute;.</h1>
			<h2>I am a <strong>Front-End Web Developer</strong>.</h2>
			<br>
			<br>
