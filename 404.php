<html>
	<head>
		<title>NOT FOUND | D'Andr&eacute; Phillips </title>
	...
	<div class="container">
		...
		<div class="cover-section col-xs-11 col-sm-8 col-md-6 col-lg-4">
			...
			<h2>Sorry, it appears that the page you were tyring to reach <strong>doesn't exist!</strong></h2>
			<br>
			<br>
			<a class="front-cta" href="javascript:history.back()">Go back</a>
