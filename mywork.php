<html>
	<head>
		<title>MY WORK | D'Andr&eacute; Phillips </title>
	...
	<div class="container">
		...
		<div class="cover-section col-xs-11 col-sm-8 col-md-6 col-lg-4">
			<h1>This is <strong>my work</strong>.</h1>
			<h2>This is <strong>what I do</strong>.</h2>
			<br>
			<br>
			<a class="front-cta" href="#">Web Development</a>
			<a class="front-cta" href="#">Branding</a>
			<a class="front-cta" href="#">Photography</a>
		</div><!-- Ends Div Class Cover Secton -->
	</div> <!-- Ends Div Class Container -->
</div> <!-- Ends Div Class Background Tint -->

<div class="row">
	<div class="full-page cv-section">
		<div class="container">
			<div class="col-md-12">
	...
	</div> <!-- Ends Div Class Full Page, CV Section -->
